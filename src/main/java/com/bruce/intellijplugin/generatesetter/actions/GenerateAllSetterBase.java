...
import com.bruce.intellijplugin.generatesetter.utils.*;
...
public abstract class GenerateAllSetterBase extends PsiElementBaseIntentionAction {
    ...
    public static Map<String, ComplexReturnTypeHandler> handlerMap = new HashMap<String, ComplexReturnTypeHandler>() {
        {
